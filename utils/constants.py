...
STRUCTURED_SINGLE_SHOT = [
    ...
    "LayerWiseSNAP",
    "LayerWiseSNAPit",
    "AdaptiveLayerWiseSNAP",
    "AdaptiveLayerWiseSNAPit",
    "StructuredRandom",
    "StructuredGRASP",
    "GateDecorators",
    "CNIP",
...
alias = {
    ...
    "AdaptiveLayerWiseSNAP": "Adaptive layer-wise SNAP (before)",
    "AdaptiveLayerWiseSNAPit": "Adaptive layer-wise SNAP-it (before)",
...
timing_names = {
    ...
    "AdaptiveLayerWiseSNAP": "before",
    "AdaptiveLayerWiseSNAPit": "before",
    "SNIPit": "before",
...
color_per_method = {
    ...
    "AdaptiveLayerWiseSNAP": "#bcbd22",
    "AdaptiveLayerWiseSNAPit": "#bcbd22",
    "SNIPit": "#d62728",
